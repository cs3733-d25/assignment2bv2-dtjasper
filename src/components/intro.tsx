...
export default function Intro(props: NameProps) {
    return(
        <>
            <h2>Introductions!</h2>
            ...
            <p>My name is Delia, and I have been crocheting for about 5 years, since 2020 (covid hobby).
                I have made a lot of things including clothes, stuffed animals, and decor. I also started a little Instagram page for the things I make! </p>
